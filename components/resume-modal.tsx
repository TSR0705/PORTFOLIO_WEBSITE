    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed inset-0 bg-black/85 backdrop-blur-md z-[100] flex items-center justify-center p-3 sm:p-4 md:p-6"
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-5xl h-[88vh] bg-[#080808] border border-[#E1E0CC]/15 rounded-2xl overflow-hidden flex flex-col shadow-[0_0_50px_rgba(225,224,204,0.06)]"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header controls bar */}
            <div className="flex items-center justify-between px-4 sm:px-6 py-3.5 border-b border-white/10 bg-black/40 backdrop-blur-sm z-10 gap-2">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <a
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-white/5 border border-white/15 text-[11px] font-mono tracking-wider text-white/90 hover:bg-white/15 hover:text-white transition-all duration-300 uppercase"
                ...
                <a
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-[#E1E0CC]/10 border border-[#E1E0CC]/30 text-[11px] font-mono tracking-wider text-[#E1E0CC] hover:bg-[#E1E0CC] hover:text-black transition-all duration-300 uppercase"
                >
                  <Download size={12} />
            ...
            <div className="flex-grow w-full h-full bg-[#0d0d0d] relative overflow-y-auto overflow-x-auto p-4 sm:p-6 md:p-8 flex justify-center items-start scroll-smooth custom-scrollbar">
              <div 
